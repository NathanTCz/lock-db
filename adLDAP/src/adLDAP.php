...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@cs.fsu.edu";
    ...
    * @var string
    */
	protected $baseDn = "ou=CSMain,dc=cs,dc=fsu,dc=edu"; 
    ...
    * @var array
    */
    protected $domainControllers = array("ldaps.cs.fsu.edu");
    ...
    * @var string
    */
	protected $adminUsername = 'UNIX-NSS-LDAP2';
    protected $adminPassword = 'Wa7uy-va#Uqe';
